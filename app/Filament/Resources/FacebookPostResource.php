    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('rewrittenArticle.title')->label('Article Réécrit')->sortable()->searchable(),
                Tables\Columns\TextColumn::make('facebookPage.name')->label('Page Facebook')->sortable()->searchable(),
                Tables\Columns\TextColumn::make('facebook_post_id')->sortable()->searchable(),
